...
const Services = () => (
  ...
  <section className="services">
    ...
    <div className="row">
      ...
      <div className="col-1-of-3">
        <h3 className="margin-bottom-small heading-tertiary">What Makes Me Different</h3>
        <p className="feature__box--text paragraph">
        I don’t just build “pretty websites” or rely on guess work. I use a proven design formula that does selling for you. A development strategy with the sole purpose for conversions, which means more potential for profit, which means inevitable success.
          </p>
      </div>
    </div>
  </section>
